...
exports.XredSpeakerIdentificationInterface = (0, xrpa_orchestrator_1.XrpaProgramInterface)("Xred.SpeakerIdentification", path_1.default.join(__dirname, "../package.json"), () => {
    const SpeakerIdentifier = (0, xrpa_orchestrator_1.ProgramInput)("SpeakerIdentifier", (0, xrpa_orchestrator_1.Collection)({
        maxCount: 1,
        fields: {
    ...
    const ReferenceSpeaker = (0, xrpa_orchestrator_1.ProgramInput)("ReferenceSpeaker", (0, xrpa_orchestrator_1.Collection)({
        ...
        fields: {
            ...
            filePath: (0, xrpa_orchestrator_1.String)("", "Path to the audio file containing the speaker's voice sample"),
            speakerIdentifier: (0, xrpa_orchestrator_1.GameComponentOwner)((0, xrpa_orchestrator_1.ReferenceTo)(SpeakerIdentifier, "Reference back to the SpeakerIdentifier that this config belongs to")),
        },
    }));
...
function SpeakerIdentifier(params) {
    const identifierNode = (0, xrpa_orchestrator_1.Instantiate)([(0, xrpa_orchestrator_1.bindExternalProgram)(exports.XredSpeakerIdentificationInterface), "SpeakerIdentifier"], {});
    (0, assert_1.default)((0, xrpa_orchestrator_1.isDataflowForeignObjectInstantiation)(identifierNode));
    ...
    return {
        identifiedSpeakerId: (0, xrpa_orchestrator_1.ObjectField)(identifierNode, "identifiedSpeakerId"),
        identifiedSpeakerName: (0, xrpa_orchestrator_1.ObjectField)(identifierNode, "identifiedSpeakerName"),
        confidenceScore: (0, xrpa_orchestrator_1.ObjectField)(identifierNode, "confidenceScore"),
        errorMessage: (0, xrpa_orchestrator_1.ObjectField)(identifierNode, "errorMessage"),
    };
}
