...
function genTransportSubsystem(fileWriter, outSrcDir, storeDef, pluginName) {
    ...
    const cppLines = [
        ...
        ...(0, xrpa_utils_1.indent)(1, (0, GenStandaloneCpp_1.genTransportInitializer)(storeDef, namespace, cppIncludes)),
        `}`,
        ``,
        `void U${name}::Deinitialize() {`,
        ...(0, xrpa_utils_1.indent)(1, (0, GenStandaloneCpp_1.genTransportDeinitializer)(storeDef)),
        `  Super::Deinitialize();`,
        `}`,
        ``,
    ];
    ...
    const headerLines = [
        ...
        ``,
        ...(0, xrpa_utils_1.indent)(1, (0, GenModuleClass_1.genInboundTransportDeclaration)(storeDef, namespace, headerIncludes, true)),
        ...(0, xrpa_utils_1.indent)(1, (0, GenModuleClass_1.genOutboundTransportDeclaration)(storeDef, namespace, headerIncludes, true)),
        `};`,
        ``,
    ];
