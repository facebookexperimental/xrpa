...
export declare function genDataflowProgramClassSpec(ctx: GenDataflowProgramContext, codegen: TargetCodeGenImpl, programDef: DataflowProgramDefinition, includes: IncludeAggregator | null): ClassSpec;
