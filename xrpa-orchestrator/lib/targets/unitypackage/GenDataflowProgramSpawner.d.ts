...
export declare function genDataflowProgramSpawner(ctx: GenDataflowProgramContext, fileWriter: FileWriter, outDir: string, programDef: DataflowProgramDefinition): void;
