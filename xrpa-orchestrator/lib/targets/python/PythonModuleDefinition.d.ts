...
export declare class PythonModuleDefinition extends ModuleDefinition {
    readonly genOutputDir: string;
    readonly libDir: string;
    readonly runtimeDir: string;
    constructor(name: string, datamap: DataMapDefinition, genOutputDir: string, guidGen?: GuidGenSpec);
