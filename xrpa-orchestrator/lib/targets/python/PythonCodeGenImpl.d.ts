...
export declare const XRPA_NAMESPACE = "xrpa_runtime";
export declare const HEADER: string[];
export declare const UNIT_TRANSFORMER: UnitTransformer;
export declare const PRIMITIVE_INTRINSICS: PrimitiveIntrinsics;
export declare function genGetCurrentClockTime(includes: IncludeAggregator | null): string;
...
export declare function identifierName(name: string, maintainPrivateMarker?: boolean): string;
export declare function privateMember(memberVarName: string): string;
export declare function methodMember(methodName: string, visibility?: ClassVisibility): string;
...
export declare function genReferencePtrToID(varName: string, _ptrType: string, objectUuidType: string): string;
