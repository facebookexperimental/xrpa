...
export declare function genProcessUpdateFunctionBody(ctx: GenDataStoreContext, includes: IncludeAggregator | null, typeDef: CollectionTypeDefinition, reconcilerDef: InputReconcilerDefinition | OutputReconcilerDefinition): string[];
