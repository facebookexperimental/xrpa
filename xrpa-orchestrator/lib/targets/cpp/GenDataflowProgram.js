...
function genDataflowProgram(ctx, fileWriter, outdir, programDef) {
    const filename = `${programDef.interfaceName}.h`;
    const classSpec = (0, GenDataflowProgramShared_1.genDataflowProgramClassSpec)(ctx, CppCodeGenImpl, programDef, new CppCodeGenImpl_1.CppIncludeAggregator());
    const lines = [
