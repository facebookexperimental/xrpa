...
function genSyntheticObject(ctx, fileWriter, outdir, syntheticObjectName, objectDef) {
    const filename = `${syntheticObjectName}.cs`;
    const classSpec = (0, GenSyntheticObjectShared_1.genSyntheticObjectClassSpec)(ctx, CsharpCodeGenImpl, syntheticObjectName, objectDef, new CsharpCodeGenImpl_1.CsIncludeAggregator());
    const lines = [
