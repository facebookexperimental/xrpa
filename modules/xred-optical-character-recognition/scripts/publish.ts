...
function getPlatformConfig() {
  return {
    ...
    outputExecutable: isWindows
      ? path.join(OSS_PATH, "xred-optical-character-recognition", "bin", "Ocr.exe")
      : path.join(OSS_PATH, "xred-optical-character-recognition", "bin", "Ocr"),
  };
}
...
async function runPublish() {
  ...
  await publish({
    ...
    outputPath: path.join(OSS_PATH, "xred-optical-character-recognition"),
  });
