...
class OutboundTrackedObject : public Xrpa::DataStoreObject {
 ...
 protected:
  ...
  Pose localRootPose_{Eigen::Vector3f{0.f, 0.f, 0.f}, Eigen::Quaternionf{1.f, 0.f, 0.f, 0.f}};
  Pose localAbsolutePose_{Eigen::Vector3f{0.f, 0.f, 0.f}, Eigen::Quaternionf{1.f, 0.f, 0.f, 0.f}};
