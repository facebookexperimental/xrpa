...
class DSVector3 {
 public:
  static ovrVector3f readValue(const Xrpa::MemoryAccessor& memAccessor, Xrpa::MemoryOffset& offset) {
  ...
  static void writeValue(const ovrVector3f& val, const Xrpa::MemoryAccessor& memAccessor, Xrpa::MemoryOffset& offset) {
...
class DSQuaternion {
 public:
  static ovrQuatf readValue(const Xrpa::MemoryAccessor& memAccessor, Xrpa::MemoryOffset& offset) {
    float x = memAccessor.readValue<float>(offset);
    float y = memAccessor.readValue<float>(offset);
    float z = memAccessor.readValue<float>(offset);
  ...
  static void writeValue(const ovrQuatf& val, const Xrpa::MemoryAccessor& memAccessor, Xrpa::MemoryOffset& offset) {
    memAccessor.writeValue<float>(-val.x, offset);
    memAccessor.writeValue<float>(-val.y, offset);
    memAccessor.writeValue<float>(val.z, offset);
...
class DSPose {
 public:
  static Pose readValue(const Xrpa::MemoryAccessor& memAccessor, Xrpa::MemoryOffset& offset) {
    ovrVector3f position = DSVector3::readValue(memAccessor, offset);
    ovrQuatf orientation = DSQuaternion::readValue(memAccessor, offset);
