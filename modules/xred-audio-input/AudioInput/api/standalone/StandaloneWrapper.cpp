...
int RunStandalone(int argc, char** argv) {
  ...
  {
    auto localAudioInputInboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("AudioInputInput", AudioInputDataStore::GenTransportConfig());
    AudioInputInboundTransport = localAudioInputInboundTransport;

    auto localAudioInputOutboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("AudioInputOutput", AudioInputDataStore::GenTransportConfig());
    AudioInputOutboundTransport = localAudioInputOutboundTransport;
  }
  auto moduleData = std::make_unique<AudioInputModule>(AudioInputInboundTransport, AudioInputOutboundTransport);
