...
class SmartControllerModule : public Xrpa::XrpaModule {
 public:
  SmartControllerModule(std::shared_ptr<Xrpa::TransportStream> SmartControllerInboundTransport, std::shared_ptr<Xrpa::TransportStream> SmartControllerOutboundTransport) {
  ...
  virtual ~SmartControllerModule() override {
    shutdown();
  }
