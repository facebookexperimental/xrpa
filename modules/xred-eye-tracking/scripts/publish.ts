...
function getPlatformConfig() {
  return {
    environmentFile: path.join(__dirname, "..", "PupilNeon", "environment.yaml"),
    outputExecutable: isWindows
      ? path.join(BIN_PATH, "PupilNeon.exe")
      : path.join(BIN_PATH, "PupilNeon"),
  };
}
...
async function runPublish() {
  ...
  await buildCondaApplication(
    ...
    path.join(__dirname, "..", "PupilNeon", "main.py"),
