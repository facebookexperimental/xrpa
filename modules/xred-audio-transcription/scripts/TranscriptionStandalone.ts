...
const TranscriptionModule = XrpaPythonStandalone("Transcription", apidir, () => {
  setProgramInterface(XredAudioTranscriptionInterface);
});

export async function doCodegen() {
  const filesToWrite = TranscriptionModule.doCodeGen();
