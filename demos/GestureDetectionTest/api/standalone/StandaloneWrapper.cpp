...
#include <lib/GestureDetectionTypes.h>
...
int RunStandalone(int argc, char** argv) {
  ...
  std::shared_ptr<Xrpa::TransportStream> GestureDetectionInboundTransport;
  ...
  {
    auto localGestureDetectionInboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("GestureDetectionOutput", GestureDetectionDataStore::GenTransportConfig());
    GestureDetectionInboundTransport = localGestureDetectionInboundTransport;

    auto localGestureDetectionOutboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("GestureDetectionInput", GestureDetectionDataStore::GenTransportConfig());
    GestureDetectionOutboundTransport = localGestureDetectionOutboundTransport;
  }
  auto moduleData = std::make_unique<GestureDetectionTestProgramModule>(CameraInboundTransport, CameraOutboundTransport, ImageViewerInboundTransport, ImageViewerOutboundTransport, GestureDetectionInboundTransport, GestureDetectionOutboundTransport);
