...
#include <lib/OpticalCharacterRecognitionTypes.h>
#include <memory>
#include <thread>
...
int RunStandalone(int argc, char** argv) {
  ...
  std::shared_ptr<Xrpa::TransportStream> OpticalCharacterRecognitionInboundTransport;
  ...
  {
    auto localOpticalCharacterRecognitionInboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("OpticalCharacterRecognitionOutput", OpticalCharacterRecognitionDataStore::GenTransportConfig());
    OpticalCharacterRecognitionInboundTransport = localOpticalCharacterRecognitionInboundTransport;

    auto localOpticalCharacterRecognitionOutboundTransport = std::make_shared<Xrpa::SharedMemoryTransportStream>("OpticalCharacterRecognitionInput", OpticalCharacterRecognitionDataStore::GenTransportConfig());
    OpticalCharacterRecognitionOutboundTransport = localOpticalCharacterRecognitionOutboundTransport;
  }
  auto moduleData = std::make_unique<OcrTestModule>(CameraInboundTransport, CameraOutboundTransport, ImageViewerInboundTransport, ImageViewerOutboundTransport, AudioInputInboundTransport, AudioInputOutboundTransport, AudioTranscriptionInboundTransport, AudioTranscriptionOutboundTransport, OpticalCharacterRecognitionInboundTransport, OpticalCharacterRecognitionOutboundTransport);
